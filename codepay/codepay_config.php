...
define('DB_USER', 'm_5v6u_cn');  //数据库用户名
define('DB_PWD', 'kEBbbsafMFBbt446');//数据库密码
define('DB_NAME', 'm_5v6u_cn');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'ds_member');  //充值用户所在数据库表名
