				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounce"  enctype="multipart/form-data"  action="<?php echo U(GROUP_NAME.'/Application/editAppHandle');?>" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="type_id">
											<?php if(is_array($type)): foreach($type as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"  <?php if($ann['application_type']['id'] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
										</select>
									</div>
								</div>
