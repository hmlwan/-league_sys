...
<?php if((isset($acc[strtoupper(GROUP_NAME)][strtoupper('Info')][strtoupper('msgReceive')])) or (!empty($_SESSION[C('ADMIN_AUTH_KEY')]))): ?><li url="InfomsgReceive">
	...
	<?php if((isset($acc[strtoupper(GROUP_NAME)][strtoupper('Counsel')][strtoupper('index')])) or (!empty($_SESSION[C('ADMIN_AUTH_KEY')]))): ?><li url="Infoannounce">
			<a href="<?php echo U(GROUP_NAME.'/Counsel/index');?>">
				<i class="icon-double-angle-right"></i>
				资讯管理
			</a>
		</li><?php endif; ?>
									...
									<div class="tab-content">
										<div id="home" class="tab-pane in active">
											<form class="form-horizontal" action="<?php echo U(GROUP_NAME.'/System/bonusConf');?>" method="post">
												...
												<div class="control-group" >
													<label class="control-label" for="SIGN_CONF">签到配置</label>

													<div class="controls">
														奖励数值范围 <input type="text" id="SIGN_RANGE" name="SIGN_RANGE" placeholder="" value="<?php echo ($config["SIGN_RANGE"]); ?>" style=" width: 100px;" class="span3"/>&nbsp;&nbsp;
														有效期 <input type="text" id="SIGN_VALID_PERIOD" name="SIGN_VALID_PERIOD" value="<?php echo (($config["SIGN_VALID_PERIOD"])?($config["SIGN_VALID_PERIOD"]):9999); ?>" style=" width: 100px;" class="span3"/>&nbsp;&nbsp;
														<font color="red">如0.01-10，30天。范围用 - 隔开,有效期为永久默认9999</font>
													</div>
												</div>

												<div class="control-group" >
													<label class="control-label"  for="update">升级配置</label>
													<div style="height: 20px;"></div>
													<div class="controls">
														高级会员：直推人数 <input type="text" id="one" name="ONE" value="<?php echo ($config["ONE"]); ?>" style=" width: 60px;" class="span3"/>&nbsp;&nbsp;
														团队人数 <input type="text" id="two" name="TWO" value="<?php echo ($config["TWO"]); ?>" style=" width: 60px;" class="span3"/>&nbsp;&nbsp;
														直推要求 <input type="text" id="two" name="THREE" value="<?php echo ($config["THREE"]); ?>" style=" width: 60px;" class="span3"/>&nbsp;&nbsp;
														奖励积分 <input type="text" id="two" name="THREE" value="<?php echo ($config["THREE"]); ?>" style=" width: 60px;" class="span3"/>&nbsp;&nbsp;
														积分有效期 <input type="text" id="two" name="THREE" value="<?php echo ($config["THREE"]); ?>" style=" width: 60px;" class="span3"/>&nbsp;&nbsp;
														直推返利比例 <input type="text" id="two" name="THREE" value="<?php echo ($config["THREE"]); ?>" style=" width: 60px;" class="span3"/>&nbsp;&nbsp;
														间推返利比例 <input type="text" id="two" name="THREE" value="<?php echo ($config["THREE"]); ?>" style=" width: 60px;" class="span3"/>&nbsp;&nbsp;
														返利有效周期 <input type="text" id="two" name="THREE" value="<?php echo ($config["THREE"]); ?>" style=" width: 60px;" class="span3"/>&nbsp;&nbsp;
													</div>
												</div>
                                            	...
                                            	<div class="control-group" >
														...
														<div class="controls">
															...
															<font color="red">已购--此处设置推荐别人购买果树时，自己已持有果树，获得奖励多。</font>
                                                        </div>
												<div style="height: 20px;"></div>
														<div class="controls">
															...
															<font color="red">未购--此处设置推荐别人购买果树时，自己未持有果树，获得奖励少。</font>
                                                        </div>
											</div>
												<div class="control-group" >
												...
												<div class="control-group" >
													...
													<div class="controls">
														直推果树数量<input type="text" id="chengzhu" name="chengzhu" value="<?php echo ($config["chengzhu"]); ?>" style=" width: 100px;" class="span3"/>&nbsp;&nbsp;<font color="red">设置直推拥有多少果树可以升级为城主。</font>
												...
												<div class="control-group">
													<label class="control-label" for="faquan">发圈赠送果树编号</label>
													<div class="controls">
														<input type="text" id="faquan" name="faquan" value="<?php echo ($config["faquan"]); ?>" style=" width: 100px;" class="span3"/>&nbsp;&nbsp;<font color="red">此处修改金币兑换果树的编号。</font>&nbsp;&nbsp;
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														金币兑换<input type="text" id="duihuan" name="duihuan" value="<?php echo ($config["duihuan"]); ?>" style=" width: 100px;" class="span3"/>&nbsp;&nbsp;<font color="red">设置兑换果树需要的金币数量。</font>
													</div>
												</div>
												<div class="control-group">
                                            ...
                                            <div class="control-group">
														<label class="control-label" for="jiesuan_time">果树结算时间间隔</label>
