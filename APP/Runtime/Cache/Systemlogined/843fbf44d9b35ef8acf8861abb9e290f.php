...
<script type="text/javascript">
    ...
    <div id="main-content" class="clearfix">
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <form id="table-searchbar" method="POST" class="form-inline well well-small">
                    <div class="row-fluid">&nbsp;&nbsp;<select class="span3" name="type" style="width: 100px;">
                        ...
                        <button type="button"  onclick="allcheck()" class="btn btn-success btn-small no-border" id="btn-compute" type="button">批量审核</button>
                        <!--	&nbsp;&nbsp;
            ...
            <form id="form1s" name="form1s" method="post"  action="<?php echo U(GROUP_NAME.'/Task/plsh');?>">
                <table id="table_report" class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                            <td><input type="checkbox" name="userids[]" value="<?php echo ($v['id']); ?>" class="allcheckbox"></td>
                            <td><?php echo ($v["id"]); ?></td>
                            ...
                            <td>
                                <?php if($v["status"] == 0): ?><a href="<?php echo U(GROUP_NAME .'/Task/completeuser',array('id'=>$v['id']));?>">查看审核</a> | <a onclick="if(confirm('删除后不可恢復！您确定要删除此会员吗?')==false)return false;" href="<?php echo U(GROUP_NAME .'/Task/deleteTask',array('id'=>$v['id']));?>">删除</a>
                                    <?php elseif($v["status"] == 1): ?>
                    ...
                    <tr>
                        <td colspan="8" style="text-align:center;"><div class="page"><?php echo ($page); ?></div></td>
                    </tr>
                    </tbody>
                </table>
