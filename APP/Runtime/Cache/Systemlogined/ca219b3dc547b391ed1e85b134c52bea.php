				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form name="editAnnounceType" class="form-horizontal"  action="<?php echo U(GROUP_NAME.'/Info/editAnnounceTypeHandle');?>" method="post">
								<div class="control-group">
									<label class="control-label" for="name"> 公告ID</label>

									<div class="controls">
										<input type="text" readonly="readonly" value="<?php echo ($type["id"]); ?>" placeholder="" />
									</div>
								</div>
								<div class="control-group">
