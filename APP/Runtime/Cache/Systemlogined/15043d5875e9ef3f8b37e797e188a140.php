				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounce"  enctype="multipart/form-data"  action="<?php echo U(GROUP_NAME.'/Counsel/editHandle');?>" method="post">
								<input type="hidden" name="id" value="<?php echo ($ann["id"]); ?>" id="id">
								<div class="control-group">
									<label class="control-label" for="name"> 标题</label>

									<div class="controls">
										<input type="text" value="<?php echo ($ann["name"]); ?>" name="name" id="name" placeholder="" />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="type_id"> 应用类别</label>

									<div class="controls">
										<select name="type_id">
											<option value="1" <?php if($ann['type_id'] == '1'): ?>selected="selected"<?php endif; ?>>热门咨询</option>
											<option value="2" <?php if($ann['type_id'] == '2'): ?>selected="selected"<?php endif; ?>>热门交易</option>
											<option value="3" <?php if($ann['type_id'] == '3'): ?>selected="selected"<?php endif; ?>>热门项目</option>
										</select>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  value="<?php echo ($ann["summary"]); ?>" name="summary" id="summary" />(五个字)
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="operator"> 发布者</label>

									<div class="controls">
										<input type="text"  value="<?php echo ($ann["operator"]); ?>" name="operator" id="operator" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="jump_url"> 跳转地址</label>

									<div class="controls">
										<input type="text"  value="<?php echo ($ann["jump_url"]); ?>" name="jump_url" id="jump_url" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sort"> 权重</label>

									<div class="controls">
										<input type="text"  value="<?php echo ($ann["sort"]); ?>" name="sort" id="sort" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sort"> 状态</label>

									<div class="controls">
										<select name="status" id="status">
											<option value="1" <?php if($ann['status'] == '1'): ?>selected="selected"<?php endif; ?>>开启</option>
											<option value="0" <?php if($ann['status'] == '0'): ?>selected="selected"<?php endif; ?>>关闭</option>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="file" name="image" value="<?php echo ($ann["logo_url"]); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="content"> 长文</label>
