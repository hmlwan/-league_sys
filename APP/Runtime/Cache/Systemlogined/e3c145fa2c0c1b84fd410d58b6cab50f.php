				...
				<div id="page-content" class="clearfix">
                       <div class="page-header position-relative">
						   <div style="text-align:left;width:100%;">
						    <a type="button" href="<?php echo U(GROUP_NAME.'/Shop/add_product');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i>添加果树</a>
						    </div>
					   </div>
					<div class="row-fluid">
