						...
						<!--PAGE CONTENT BEGINS HERE-->
							<form name="editAnnounceType" class="form-horizontal"  action="<?php echo U(GROUP_NAME.'/Member/addJinbiHandle');?>" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" readonly="readonly" value="<?php echo ($member["truename"]); ?>" id="truename"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="kingb"> 账户余额</label>

									<div class="controls">
										<input type="text" readonly="readonly" value="<?php echo ($member["money"]); ?>" id="kingb"/>
									</div>
								</div>
								<div class="control-group">
									...
									充值金额：</label>
									<div class="controls">
										<input type="text" name="money" id="money" />扣除请充值负数！
									</div>
								</div>
