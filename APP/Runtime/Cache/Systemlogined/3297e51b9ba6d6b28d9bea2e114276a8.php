				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounceType"  action="<?php echo U(GROUP_NAME.'/Application/editAppTypeHandle');?>" method="post">
								<input type="hidden" name="id" value="<?php echo ($type["id"]); ?>">
								<div class="control-group">
									<label class="control-label" for="name"> 主题</label>

									<div class="controls">
										<input type="text" value="<?php echo ($type["name"]); ?>" name="name" id="name" placeholder="" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="num"> 广告位数量</label>

									<div class="controls">
										<input type="text" value="<?php echo ($type["num"]); ?>" name="num" id="num" placeholder="" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="<?php echo ($type["sort"]); ?>" name="sort" id="sort" placeholder="" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<select name="status" id="status">
											<option value="1" <?php if($type['status'] == '1'): ?>selected="selected"<?php endif; ?>>开启</option>
											<option value="0" <?php if($type['status'] == '0'): ?>selected="selected"<?php endif; ?>>关闭</option>
