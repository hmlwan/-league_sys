	...
	<div id="main-content" class="clearfix">
		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<form name="editAnnounceType" class="form-horizontal"  action="<?php echo U(GROUP_NAME.'/Shop/addshouyi');?>" method="post">
					<div class="control-group">
						<label class="control-label" for="jifen">
							果树编号：</label>
						<div class="controls">
							<select name="id" id="id" onChange="getpnum();">
					...
					<div class="control-group">
						<label class="control-label" for="num">
							修改收益：</label>
						<div class="controls">
							<input type="text" name="num" id="num" /><font color="red">这里修改所有购买的果树每小时的收益产出。</font>
						</div>
					</div>
