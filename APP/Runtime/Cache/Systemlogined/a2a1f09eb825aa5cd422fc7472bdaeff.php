				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addProductHandle"  enctype="multipart/form-data" action="<?php echo U(GROUP_NAME .'/Shop/addProductHandle');?>" method="post">
									...
									<div class="controls">
									   <select name="tid">
									     <option value="-1">请选择分类</option>	   
											<?php if(is_array($types)): foreach($types as $key=>$type): ?><option value="<?php echo ($type["id"]); ?>"><?php echo ($type["name"]); ?></option><?php endforeach; endif; ?>
										</select>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="yxzq" id="yxzq" placeholder="" />
									</div>
								</div>	
								<div class="control-group">
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="xiangou" id="xiangou" placeholder="" />
									</div>
								</div>	
