				...
				<div id="page-content" class="clearfix">
					<div class="page-header position-relative">
						<div style="text-align:left;width:100%;">
						    <a type="button" href="<?php echo U(GROUP_NAME.'/Application/addapptype');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i> 添加应用类别</a>
						</div>
					</div><!--/.page-header-->
		...
		<script type="text/javascript">
			$(function() {
				...
				$('.btn-info').click(function(){
					...
					var url = '<?php echo U(GROUP_NAME .'/Application/editapptype');?>'+'/id/'+ uid;
					window.location = url;
				});
				...
				$('.btn-danger').click(function(){
					...
					bootbox.confirm("确认删除吗?", function(result) {
						if(result) {
							var url = '<?php echo U(GROUP_NAME .'/Application/deleteAppType');?>'+'/id/'+ uid;
							window.location = url;
						}
					});
