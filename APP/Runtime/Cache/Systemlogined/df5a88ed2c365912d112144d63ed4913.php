				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounce"  enctype="multipart/form-data"  action="<?php echo U(GROUP_NAME.'/Counsel/addHandle');?>" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="type_id">
											<option value="1">热门咨询</option>
											<option value="2">热门交易</option>
											<option value="3">热门项目</option>
										</select>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  value="" name="summary" id="summary" />(五个字)
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  value="" name="jump_url" id="jump_url" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  value="" name="operator" id="operator" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  value="" name="sort" id="sort" />
									</div>
								</div>
								<div class="control-group">
