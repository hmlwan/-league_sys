				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounce"  enctype="multipart/form-data"  action="<?php echo U(GROUP_NAME.'/Application/addDownHandle');?>" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="size" id="size" placeholder="" /><span>(单位：MB)</span>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="score" id="score" placeholder="" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="person_num" id="person_num" placeholder="" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="person_num_unit" id="person_num_unit" placeholder="" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="install_num" id="install_num" placeholder="" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="install_num_unit" id="install_num_unit" placeholder="" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  value="" name="android_url" id="android_url" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  value="" name="ios_url" id="ios_url" />
									</div>
								</div>
								<div class="control-group">
