				...
				<div id="page-content" class="clearfix">
					<div class="page-header position-relative">
						<div style="text-align:left;width:100%;">
						    <a type="button" href="<?php echo U(GROUP_NAME.'/Application/addapp');?>" class="btn btn-small btn-info no-border"> <i class="icon-plus icon-white"></i> 添加应用</a>
						</div>
					</div><!--/.page-header-->
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php if(is_array($ann)): foreach($ann as $key=>$v): ?><tr>
											...
											<td class="hidden-480"><?php echo ($v["application_type"]["name"]); ?></td>
		...
		<script type="text/javascript">
			$(function() {
				...
				$('.btn-info').click(function(){
					...
					var url = '<?php echo U(GROUP_NAME .'/Application/editapp');?>'+'/id/'+ aid;
					window.location = url;
				});
				...
				$('.btn-danger').click(function(){
					...
					bootbox.confirm("确认删除吗?", function(result) {
						if(result) {
							var url = '<?php echo U(GROUP_NAME .'/Application/deleteApp');?>'+'/id/'+ aid;
							window.location = url;
						}
					});
