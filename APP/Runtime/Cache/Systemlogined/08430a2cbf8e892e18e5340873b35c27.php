				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounceType"  action="<?php echo U(GROUP_NAME.'/Application/addAppTypeHandle');?>" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" name="num" id="num" placeholder="" />
									</div>
								</div>
								<div class="control-group">
