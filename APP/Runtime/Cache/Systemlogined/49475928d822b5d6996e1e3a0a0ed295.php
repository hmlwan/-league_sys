  ...
  <div id="main-content" class="clearfix">
    ...
    <div id="page-content" class="clearfix">
      ...
      <div class="row-fluid">
        ...
        <form id="table-searchbar" method="POST" action="<?php echo U(GROUP_NAME.'/Jinbidetail/emoneyWithdraw');?>"
              class="form-inline well well-small">
          <div class="row-fluid">&nbsp;&nbsp;用户编号
            <input type="text" class="input-small" name="account" value="<?php echo $_POST['account'];?>">
            &nbsp;&nbsp;开始日期
            <input type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo $_POST['start_time'];?>"
                   class="input-small" name="start_time">
            &nbsp;&nbsp;截止日期
            <input type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo $_POST['end_time'];?>"
                   class="input-small" name="end_time">
            <button type="submit" class="btn btn-small no-border" id="btn-query" type="button"><i
        ...
        <div class="row-fluid">
          <table id="table_report" class="table table-striped table-bordered table-hover">
            ...
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                ...
                <td><?php echo (date('Y-m-d H:i:s',$v["applyDate"])); ?></td>
                <td>
                  <?php if($v["status"] == 0): ?><a href="<?php echo U(GROUP_NAME.'/Jinbidetail/editEmoney',array('id'=>$v['id']));?>">提现处理</a>
                    <?php else: ?>
                    已处理<?php endif; ?>
                </td>
