			...
			<div id="main-content" class="clearfix">
				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						...
						<form id="table-searchbar" method="POST" action="<?php echo U(GROUP_NAME.'/member/awardlist');?>" class="form-inline well well-small">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
											...
											<td>
                                            	<?php if($v['send_style'] == 1): ?><font style="color:#F00;">赠送果树</font><?php endif; ?>
                                            </td>
