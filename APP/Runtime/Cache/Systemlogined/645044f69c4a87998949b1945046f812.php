				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounce" enctype="multipart/form-data"   action="<?php echo U(GROUP_NAME.'/Info/editAnnounceHandle');?>" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="file" name="path" value="<?php echo ($ann["path"]); ?>"> 缩略图大小：300*250
									</div>
								</div>
								<div class="control-group">
