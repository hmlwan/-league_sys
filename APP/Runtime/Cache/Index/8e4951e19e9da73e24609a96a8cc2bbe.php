...
<body onload="onload()" class="framework7-root">
    ...
    position: absolute;
        z-index: 9;
    top: 26%;
    left: 35%;"><?php echo ($inviteCode); ?></span>
...
<div class="views">
  <div class="view view-main" data-page="myextend">
    <div class="pages">
      <div data-page="myextend" class="page navbar-fixed" isinited="true">
        <div class="page-content center">
          <img id="sharedImg" src="/Public/encard.jpg" style="width: auto;
    max-width: 100%;
    height: auto;
    max-height: 100%;
    position: absolute;
    z-index: 1;
    left: 0;">
          <img src="/Public/shu/2.jpg" style="position: absolute;
    z-index: 99;
    width: 200px;
    height: 200px;
    left: 6rem;
...
<!--
<a class="bcemw" href="<?php echo ($erwei); ?>" download>保存二维码</a>
-->
</body>
</html>