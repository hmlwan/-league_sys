...
<head>
    <meta charset="UTF-8">
    <title>
        <?php switch($type_id): case "1": ?>热门咨询<?php break;?>
            <?php case "2": ?>热门交易所<?php break;?>
...
<body>
    ...
    <?php if($list): ?><div class="sy_page rmzx_page">
            <div class="sy_box sy_xm flow_load">
...
<script>
    lazy_loading('/index/index/get_more/type_id/<?php echo ($type_id); ?>');
</script>
</html>