...
<div class="tixian-log-top">
  <p>累计收益<a href="#" style="font-size: 12px;">(不计果树收益)</a><span><?php echo ($shouyi); ?>Usdt</span></p>
</div>
  ...
  <ul>
    <?php if(is_array($list)): foreach($list as $key=>$v): ?><li>
        <p class="tixian-log-p">
          ...
          <a href="#">
            <?php if($v["adds"] == 0.00): ?>-<?php echo (two_number($v["reduce"])); ?>
              <?php else: ?>
              +<?php echo (two_number($v["adds"])); endif; ?>
          </a>
        </p>
...
<div class="award-index-ycc"
     style="width: 100%;color: #000;float: left; height: 2.5rem;line-height: 2.5rem;text-align: center;">
  <?php echo ($page); ?>
</div>
