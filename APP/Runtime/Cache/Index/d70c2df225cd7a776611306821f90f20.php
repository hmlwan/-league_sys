...
<input type="hidden" name="mui-tab-item" value="3">
    ...
    <header>
        <div class="header_bt">
            ...
            <div class="header_c"><?php echo ($type_name); ?></div>
        </div>
        <div style="height: .74rem;clear: both;"></div>
    </header>
<?php if($list): ?><div class="yyxq_page yy_page">
        <div class="yy_item">
            <div class="yy_con flexbox wrap">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p onclick="window.location.href='<?php echo ($v["jump_url"]); ?>'">
