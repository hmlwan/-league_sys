...
<body style="background-color: #f2f2f2">
    <header>
        <div class="header_bt">
            <div class="header_f"><a href="<?php echo U('/index/member/index');?>" class="header_fh"></a></div>
            <div class="header_c">官方公告</div>
        </div>
        <div style="height: .74rem;clear: both;"></div>
    </header>
    <?php if($list): ?><div class="gfgg_page flow_load">
...
<script>
    lazy_loading('/index/member/announce');
</script>
</html>