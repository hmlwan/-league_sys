/* This file is created by MySQLReback 2020-03-13 23:02:54 */
 /* 创建表结构 `ds_announce` */
 DROP TABLE IF EXISTS `ds_announce`;/* MySQLReback Separation */ CREATE TABLE `ds_announce` (
  ...
  PRIMARY KEY (`id`),
  KEY `tid` (`tid`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=755 ROW_FORMAT=DYNAMIC COMMENT='公告信息表';/* MySQLReback Separation */
 /* 插入数据 `ds_announce` */
 INSERT INTO `ds_announce` VALUES ('1','测试','测试','admin','1584093263','1584093263','/Public/Uploads/zixun/20200313/5e6b585fcdaa6.png','all','1');/* MySQLReback Separation */
 ...
 INSERT INTO `ds_announcetype` VALUES ('1','生态公告');/* MySQLReback Separation */
 /* 创建表结构 `ds_auth_group` */
 ...
 DROP TABLE IF EXISTS `ds_member`;/* MySQLReback Separation */ CREATE TABLE `ds_member` (
  ...
  KEY `username` (`username`),
  KEY `parent` (`parent`)
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=278 ROW_FORMAT=DYNAMIC COMMENT='会员';/* MySQLReback Separation */
 /* 插入数据 `ds_member` */
 INSERT INTO `ds_member` VALUES ('2','15888888888','e10adc3949ba59abbe56e057f20f883e','0','UGL289','','美国','1584031737','18888888888','1','','0','','','0.00','1','会员','0.00','初始账户','','1584096019','1','0','9','1|1|','1584099207','','',''),('3','13888888888','e10adc3949ba59abbe56e057f20f883e','0','YKB572','','美国','1584031868','15888888888','2','','0','','','0.00','0','会员','0.00','初始账号','','1584104029','0','0','5','1|1|26|','1584104033','','',''),('1','18888888888','c198f91111c8a8a7615a2b20f21e11eb','0','WSB903','','美国','1584030607','1550000000','0','','0','','','0.00','1','会员','0.00','初始账户','','1584099157','2','0','13','1|','1584099381','','','');/* MySQLReback Separation */
 ...
 DROP TABLE IF EXISTS `ds_product`;/* MySQLReback Separation */ CREATE TABLE `ds_product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;/* MySQLReback Separation */
 /* 插入数据 `ds_product` */
 INSERT INTO `ds_product` VALUES ('1','1','树苗','100.00','18','720','0.17','/Public/Uploads/20200313/5e6b2e0ca7520.png','','0','1584081321','1','0'),('2','2','紫檀','500.00','100','1440','0.49','/Public/Uploads/20200313/5e6b3154bccdc.png','','0','1584083284','3','0'),('3','3','沉香','1000.00','50','2160','0.75','/Public/Uploads/20200313/5e6b31dbc9cb7.png','','0','1584083419','3','0'),('4','4','金丝楠','3000.00','30','2160','2.51','/Public/Uploads/20200313/5e6b322b9cc1b.png','','0','1584083499','2','0'),('5','5','黄花梨','5000.00','10','2160','4.65','/Public/Uploads/20200313/5e6b326d4d295.png','','0','1584083565','1','0');/* MySQLReback Separation */
 ...
 /* 插入数据 `ds_user` */
 INSERT INTO `ds_user` VALUES ('1','admin','39b9ff373cf9027e724ae7afe55e6d41','1584031554','180.127.157.6','0');/* MySQLReback Separation */
 /* 创建表结构 `ds_xiangmu` */
